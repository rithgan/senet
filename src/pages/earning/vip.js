...
export default function Vip({ ipAddress, loginData }) {
                    ...
                    <div className="col-md-12  mb-2">
                        ...
                        <div className="card-header align-items-center ">
                            <div className="card-title mb-0">
                                <h6 className="m-0 me-2 mb-2 text-center text-info">VIP Uni-Level Reward</h6>
                            ...
                            <div className="card h-100" id={index}>
                              <div className="card-header align-items-center" style={{padding :"3% 5% 3% 5%"}}>
                                <div className="col-md-12">
                                  ...
                                  <div className='row d-flex justify-content-between'>
                                    <div className='col-6 text-left'>
                                        <small className="text-sm">Rank</small>
                                    </div>
                                    <div className='col-6' style={{textAlignLast:"end"}}>
                                      <small className="text-sm">VIP-{list.top}</small>
                                    </div>
                                  </div>
                                  <div className='row d-flex justify-content-between'>
                                    <div className='col-6 text-left'>
